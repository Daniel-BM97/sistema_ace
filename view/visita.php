...
<body>
  ...
  <div class="form-container">
    <div style="font-size:12px; color:#666; margin-bottom:12px;">
      <a href="index.php?page=home" style="color:#1976d2; text-decoration:none;">Home</a> &gt; <a href="index.php?page=area" style="color:#1976d2; text-decoration:none;">Áreas</a> &gt; <a href="index.php?page=rg&cod_area=<?php echo urlencode($dados_quarteirao['cod_area'] ?? ''); ?>" style="color:#1976d2; text-decoration:none;">Quarteirões</a> &gt; <a href="index.php?page=imoveis&id_quarteirao=<?php echo urlencode($id_quarteirao ?? ''); ?>&cod_area=<?php echo urlencode($dados_quarteirao['cod_area'] ?? ''); ?>" style="color:#1976d2; text-decoration:none;">Imóveis</a> &gt; <span style="color:#333; font-weight:600;">Visita</span>
    </div>
    <h2><?php echo $dados_quarteirao['nome_area'] . " - " . $dados_quarteirao['numero_quarteirao'] ?></h2>

    <form method="post" action="index.php?page=deposito&id_visita=<?php echo $id_visita ?>">
      <label for="id"></label>
      ...
      <input type="hidden" name="cod_area" value="<?php echo $dados_quarteirao['cod_area'] ?>">
  ...
  <script>
    function voltar() {
      window.location.href = 'index.php?page=imoveis&id_quarteirao=<?php echo urlencode($id_quarteirao ?? ''); ?>&cod_area=<?php echo urlencode($dados_quarteirao['cod_area'] ?? ''); ?>';
    }
