...
<body>
  ...
  <div class="container">
    <div style="font-size:12px; color:#666; margin-bottom:16px;">
      <a href="index.php?page=home" style="color:#1976d2; text-decoration:none;">Home</a> &gt; <a href="index.php?page=area" style="color:#1976d2; text-decoration:none;">Áreas</a> &gt; <span style="color:#333; font-weight:600;">Quarteirões</span>
    </div>
      ...
      <tbody>
        ...
        <?php else: ?>
          ...
          <tr>
            ...
            <td>
              <form action="index.php?page=imoveis&id_quarteirao=<?php echo $q['id_quarteirao'] ?>&cod_area=<?php echo urlencode($q['cod_area'] ?? ''); ?>" method="post">
    ...
    <button class="btn btn-voltar" onclick="window.location.href='index.php?page=area';">Voltar</button>
  </div>
