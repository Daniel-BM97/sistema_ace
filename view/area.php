...
<body>
  ...
  <div class="container">
    <div style="font-size:12px; color:#666; margin-bottom:16px;">
      <a href="index.php?page=home" style="color:#1976d2; text-decoration:none;">Home</a> &gt; <span style="color:#333; font-weight:600;">Áreas</span>
    </div>
        ...
        <?php else: ?>
          <?php foreach ($areas as $a): ?>
            <tr>
              ...
              <td>
                <form action="index.php?page=rg&cod_area=<?php echo $a['cod_area']; ?>" method="post">
    ...
    <a href="index.php?page=home" class="btn btn-voltar">Voltar</a>
  </div>
